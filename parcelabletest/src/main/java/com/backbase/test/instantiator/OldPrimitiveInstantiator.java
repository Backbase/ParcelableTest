 ...
 *
 * A specialized {@link OldInstantiator} that supports primitives, strings, and enums.
 */
@Deprecated
public abstract class OldPrimitiveInstantiator extends TypeLimitedInstantiator {
